		...
		<InsightCard className='p-0 overflow-hidden h-[240px] md:h-[120px]'>
			...
			>
				<Stat
					...
					value={peers}
					unit='Peers'
					description={`These are the total number of peers that you are connected to.
				...
				<Stat
					...
					value={memVal}
					unit={memUnit}
					description={`This is the RAM your node's mempool is currently using to store unconfirmed transactions that it knows about. The number is unique to *your* node (every node sees a different set of pending transactions).`}
				/>
				<Stat
