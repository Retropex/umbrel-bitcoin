// Bitcoin Knots's ZMQ `pubhashtx` transaction notifier is NOT SILENT during IBD and initial Bitcoin Knots startup (unlike `pubhashblock`)
...
//
// Catch-up behaviour:
// When the node was offline or just exited IBD (Knots flips IBD false when the chain tip is
