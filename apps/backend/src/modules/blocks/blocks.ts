...
//   IBD:      ZMQ is silent (Knots suppresses notifications during IBD). Frontend does not
...
//              2. During initial sync — Knots IBD flag flips to false when the chain
...
// Bitcoin Knots ZMQ block notifiers are silent during IBD, so this only fires
